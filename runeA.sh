...
for qrange in "${q_ranges[@]}"; do
  ...
  for i in $(seq -w 0 9); do
    for b1 in "${bools[@]}"; do
      for b2 in "${bools[@]}"; do
        input_file="inputfiles/eAu_10x100_${qrange}/split/part_${i}.list"
        output_file="./results/${qrange}/JetOut_eAu_${qrange}_${i}_b1_${b1}_b2_${b2}.histos.root"
        log_file="./log/${qrange}/out_eAu_${qrange}_${i}_b1_${b1}_b2_${b2}.log"
